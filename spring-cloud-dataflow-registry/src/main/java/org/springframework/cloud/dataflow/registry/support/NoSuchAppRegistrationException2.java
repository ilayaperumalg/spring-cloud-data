 ...
 */
public class NoSuchAppRegistrationException2 extends RuntimeException {

	private static final long serialVersionUID = 1L;

	public NoSuchAppRegistrationException2(String name, ApplicationType type, String version) {
