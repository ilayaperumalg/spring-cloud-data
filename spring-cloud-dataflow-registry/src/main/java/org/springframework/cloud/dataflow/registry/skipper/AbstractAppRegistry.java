 ...
 */
public interface AbstractAppRegistry {

	AppRegistration find(String name, ApplicationType type, String version);

	List<AppRegistration> findAll();

	Page<AppRegistration> findAll(Pageable pageable);

	AppRegistration save(String name, ApplicationType type, URI uri, URI metadataUri);
